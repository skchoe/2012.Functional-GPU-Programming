...
|#
;(define CUBLAS_STATUS_SUCCESS           #x00000000)
;(define CUBLAS_STATUS_NOT_INITIALIZED   #x00000001)
;(define CUBLAS_STATUS_ALLOC_FAILED      #x00000003)
;(define CUBLAS_STATUS_INVALID_VALUE     #x00000007)
;(define CUBLAS_STATUS_ARCH_MISMATCH     #x00000008)
;(define CUBLAS_STATUS_MAPPING_ERROR     #x0000000B)
;(define CUBLAS_STATUS_EXECUTION_FAILED  #x0000000D)
;(define CUBLAS_STATUS_INTERNAL_ERROR    #x0000000E)


;/* CUBLAS data types */
;typedef unsigned int cublasStatus;
(define _cublasStatus
  (_enum
   '(CUBLAS_STATUS_SUCCESS           = #x0
     CUBLAS_STATUS_NOT_INITIALIZED   = #x1
     CUBLAS_STATUS_ALLOC_FAILED      = #x3
     CUBLAS_STATUS_INVALID_VALUE     = #x7
     CUBLAS_STATUS_ARCH_MISMATCH     = #x8
     CUBLAS_STATUS_MAPPING_ERROR     = #xB
     CUBLAS_STATUS_EXECUTION_FAILED  = #xD
     CUBLAS_STATUS_INTERNAL_ERROR    = #xE)))

;/* CUBLAS helper functions 108 foreign definitions */
...
|#
(define-foreign-cublas cublasInit -> (result : _cublasStatus))
...
|#
(define-foreign-cublas cublasShutdown  -> (result : _cublasStatus))
...
|#
(define-foreign-cublas cublasGetError  -> (result : _cublasStatus))
...
(define-foreign-cublas cublasAlloc (n : _int)
                                   (elemSize : _int)
                                   (devicePtr : (_ptr o _pointer))
                                   -> (result : _cublasStatus)
                                   -> (values result devicePtr))
...
|#
(define-foreign-cublas cublasFree (devicePtr : _pointer)
                                  -> (result : _cublasStatus))
...
|#
(define-foreign-cublas cublasSetVector (n : _int)
                                       (elemSize : _int)
                                       (x : _pointer)
                                       (incx : _int)
                                       (devicePtr : _pointer)
...
|#
(define-foreign-cublas cublasGetVector (n : _int)
                                       (elemSize : _int)
                                       (x : _pointer)
                                       (incx : _int)
                                       (y : _pointer)
...
cublasStatus CUBLASAPI cublasSetMatrix (int rows, int cols, int elemSize, 
                                        ...
                                        int ldb);
|#
(define-foreign-cublas cublasSetMatrix (rows : _int)
                                       (cols : _int)
                                       (elemSize : _int)
                                       (A : _pointer)
                                       (lda : _int)
...
cublasStatus CUBLASAPI cublasGetMatrix (int rows, int cols, int elemSize, 
                                        ...
                                        int ldb);
|#
(define-foreign-cublas cublasGetMatrix (rows : _int)
                                       (cols : _int)
                                       (elemSize : _int)
                                       (A : _pointer)
                                       (lda : _int)
...
|#
(define-foreign-cublas cublasIsamax (n : _int)
                                    (x : (_cpointer '_float))
                                    (incx : _int)
                                 -> (idx : _int))
...
|#
(define-foreign-cublas cublasIsamin (n : _int)
                                    (x : (_cpointer '_float))
                                    (incx : _int)
                                 -> (idx : _int))
...
|#
(define-foreign-cublas cublasSasum  (n : _int)
                                    (x : (_cpointer '_float))
                                    (incx : _int)
                                 -> (sum : _float))
...
void CUBLASAPI cublasSaxpy (int n, float alpha, const float *x, int incx, 
                            float *y, int incy);
|#
(define-foreign-cublas cublasSaxpy (n : _int)
                                   (alpha : _float)
                                   (x : (_cpointer 'float))
                                   (incx : _int)
                                   (y : (_cpointer 'float))
...
void CUBLASAPI cublasScopy (int n, const float *x, int incx, float *y, 
                            int incy);
|#
(define-foreign-cublas cublasScopy (n : _int)
                                   (x : (_cpointer 'float))
                                   (incx : _int)
                                   (y : (_cpointer 'float))
                                   (incy : _int)
...
float CUBLASAPI cublasSdot (int n, const float *x, int incx, const float *y, 
                            int incy);
|#
(define-foreign-cublas cublasSdot (n : _int)
                                  (x : (_cpointer 'float))
                                  (incx : _int)
                                  (y : (_cpointer 'float))
                                  (incy : _int)
...
|#
(define-foreign-cublas cublasSnrm2 (n : _int)
                                   (x : (_cpointer 'float))
                                   (incx : _int)
                                -> (nrm2 : _float))
...
void CUBLASAPI cublasSrot (int n, float *x, int incx, float *y, int incy, 
                           float sc, float ss);
|#
(define-foreign-cublas cublasSrot (n : _int)
                                  (x : (_cpointer 'float))
                                  (incx : _int)
                                  (y : (_cpointer 'float))
                                  (incy : _int)
...
(define-foreign-cublas cublasSrotg (sa : _float) (sb : _float)
                                   (sc : (_ptr o _float))
                                   (ss : (_ptr o _float))
                                -> _void
                                -> (values sa sb sc ss))
...
(define-foreign-cublas cublas (n : _int) (x : (_cpointer 'float)) 
                                         (incx : _int)
                                         (y : (_cpointer 'float)) 
                                         (incy : _int)
                              (sparam : (_cpointer 'float))
                           -> _void 
                           -> (values x y))
...
(define-foreign-cublas cublasSrotmg (sd1 : (_ptr io _float))
                                    (sd2 : (_ptr io _float))
                                    (sx1 : (_ptr io _float))
                                    (sy1 : _float)
                                    (sparam : (_cpointer 'float))
                                 -> _void
                                 -> (values sd1 sd2 sx1 sparam))
...
|#
(define-foreign-cublas cublasSscal (n : _int)
                                   (alpha : _float)
                                   (x : (_cpointer 'float))
                                   (incx : _int)
                                -> _void
...
|#
(define-foreign-cublas cublasSswap (n : _int)
                                   (x : (_cpointer 'float))
                                   (incx : _int)
                                   (y : (_cpointer 'float))
                                   (incy : _int)
...
|#
(define-foreign-cublas cublasCaxpy (n : _int)
                                   (alpha : _float2 #|_cuComplex|#)
                                   (x : (_cpointer 'cuComplex))
                                   (incx : _int)
                                   (y : (_cpointer 'cuComplex))
                                   (incy : _int)
                                -> _void
                                -> (values x y))
...
void CUBLASAPI cublasCcopy (int n, const cuComplex *x, int incx, cuComplex *y,
                            int incy);
|#
(define-foreign-cublas cublasCcopy (n : _int)
                                   (x : (_cpointer 'cuComplex))
                                   (incx : _int)
                                   (y : (_cpointer 'cuComplex))
                                   (incy : _int)
...
|#
(define-foreign-cublas cublasCscal (n : _int)
                                   (alpha : _float2 #|_cuComplex|#)
                                   (x : (_cpointer 'cuComplex))
                                   (incx : _int)
                                -> _void
...
__host__ void CUBLASAPI cublasCrotg (cuComplex *pca, cuComplex cb, float *psc,
                                     cuComplex *pcs);
|#
(define-foreign-cublas cublasCrotg (pca : (_cpointer 'cuComplex))
                                   (cb : _float2 #|_cuComplex|#)
                                   (psc : (_ptr o (_cpointer 'float)))
                                   (pcs : (_ptr o (_cpointer 'float)))
                                -> _void
                                -> (values pca psc pcs))
...
|#
(define-foreign-cublas cublasCrot (n : _int)
                                  (x : (_cpointer 'cuComplex))
                                  (incx : _int)
                                  (y : (_cpointer 'cuComplex))
                                  (incy : _int)
                                  (c : _float)
                                  (s : _float2 #|_cuComplex|#)
                               -> _void
                               -> (values x y))
...
|#
(define-foreign-cublas cublasCsrot (n : _int)
                                   (x : (_cpointer 'cuComplex))
                                   (incx : _int)
                                   (y : (_cpointer 'cuComplex))
                                   (incy : _int)
...
|#
(define-foreign-cublas cublasCsscal (n : _int)
                                    (alpha : _float)
                                    (x : (_cpointer 'cuComplex))
                                    (incx : _int)
                                 -> _void
...
void CUBLASAPI cublasCswap (int n, cuComplex *x, int incx, cuComplex *y,
                            int incy);
|#
(define-foreign-cublas cublasCswap  (n : _int)
                                    (x : (_cpointer 'cuComplex))
                                    (incx : _int)
                                    (y : (_cpointer 'cuComplex))
                                    (incy : _int)
...
|#
(define-foreign-cublas cublasCdotu  (n : _int)
                                    (x : (_cpointer 'cuComplex))
                                    (incx : _int)
                                    (y : (_cpointer 'cuComplex))
                                    (incy : _int)
                                 -> (result : _float2 #|_cuComplex|#))
...
cuComplex CUBLASAPI cublasCdotc (int n, const cuComplex *x, int incx, 
                                 const cuComplex *y, int incy);
|#
(define-foreign-cublas cublasCdotc  (n : _int)
                                    (x : (_cpointer 'cuComplex))
                                    (incx : _int)
                                    (y : (_cpointer 'cuComplex))
                                    (incy : _int)
...
|#
(define-foreign-cublas cublasIcamax (n : _int)
                                    (x : (_cpointer 'float))
                                    (incx : _int)
                                 -> (result : _int))
...
|#
(define-foreign-cublas cublasIcamin (n : _int)
                                    (x : (_cpointer 'float))
                                    (incx : _int)
                                 -> (result : _int))
...
|#
(define-foreign-cublas cublasScasum (n : _int)
                                    (x : (_cpointer 'cuComplex))
                                    (incx : _int)
                                 -> (result : _float))
...
|#
(define-foreign-cublas cublasScnrm2 (n : _int)
                                    (x : (_cpointer 'cuComplex))
                                    (inc : _int)
                                 -> (result : _float))
...
void CUBLASAPI cublasSgbmv (char trans, int m, int n, int kl, int ku, 
                            ...
                            int incy);
|#
(define-foreign-cublas cublasSgbmv (trans : _byte)
                                   (m : _int)
                                   (n : _int)
                                   (kl : _int)
                                   (ku : _int)
...
|#
(define-foreign-cublas cublasSegmv (trans : _byte)
                                   (m : _int)
                                   (n : _int)
                                   (alpha : _float)
                                   (A : (_cpointer 'float))
...
void CUBLASAPI cublasSger (int m, int n, float alpha, const float *x, int incx,
                           const float *y, int incy, float *A, int lda);
|#
(define-foreign-cublas cublasSger  (m : _int)
                                   (n : _int)
                                   (alpha : _float)
                                   (x : (_cpointer 'float))
                                   (incx : _int)
...
void CUBLASAPI cublasSsbmv (char uplo, int n, int k, float alpha, 
                            ...
                            float beta, float *y, int incy);
|#
(define-foreign-cublas cublasSsbmv (uplo : _byte)
                                   (n : _int)
                                   (k : _int)
                                   (alpha : _float)
                                   (A : (_cpointer 'float))
...
void CUBLASAPI cublasSspmv (char uplo, int n, float alpha, const float *AP, 
                            ...
                            int incy);
|#
(define-foreign-cublas cublasSspmv (uplo : _byte)
                                   (n : _int)
                                   (alpha : _float)
                                   (AP : (_cpointer 'float))
                                   (x : (_cpointer 'float))
...
void CUBLASAPI cublasSspr (char uplo, int n, float alpha, const float *x,
                           int incx, float *AP);
|#
(define-foreign-cublas cublasSspr  (uplo : _byte)
                                   (n : _int)
                                   (alpha : _float)
                                   (x : (_cpointer 'float))
                                   (incx : _int)
...
|#
(define-foreign-cublas cublasSspr2 (uplo : _byte)
                                   (n : _int)
                                   (alpha : _float)
                                   (x : (_cpointer 'float))
                                   (incx : _int)
...
void CUBLASAPI cublasSsymv (char uplo, int n, float alpha, const float *A,
                            ...
                            float *y, int incy);
|#
(define-foreign-cublas cublasSsymv (uplo : _byte)
                                   (n : _int)
                                   (alpha : _float)
                                   (A : (_cpointer 'float))
                                   (lda : _int)
...
|#
(define-foreign-cublas cublasSsyr  (uplo : _byte)
                                   (n : _int)
                                   (alpha : _float)
                                   (x : (_cpointer 'float))
                                   (incx : _int)
...
void CUBLASAPI cublasSsyr2 (char uplo, int n, float alpha, const float *x, 
                            ...
                            int lda);
|#
(define-foreign-cublas cublasSsyr2 (uplo : _byte)
                                   (n : _int)
                                   (alpha : _float)
                                   (x : (_cpointer 'float))
                                   (incx : _int)
...
|#
(define-foreign-cublas cublasStbmv (uplo : _byte)
                                   (trans : _byte)
                                   (diag : _byte)
                                   (n : _int)
                                   (k : _int)
...
void CUBLASAPI cublasStbsv (char uplo, char trans, char diag, int n, int k, 
                            const float *A, int lda, float *x, int incx);
|#
(define-foreign-cublas cublasStbsv (uplo : _byte)
                                   (trans : _byte)
                                   (diag : _byte)
                                   (n : _int)
                                   (k : _int)
...
|#
(define-foreign-cublas cublasStpmv (uplo : _byte)
                                   (trans : _byte)
                                   (diag : _byte)
                                   (n : _int)
                                   (AP : (_cpointer 'float))
...
void CUBLASAPI cublasStpsv (char uplo, char trans, char diag, int n,
                            const float *AP, float *x, int incx);
|#
(define-foreign-cublas cublasStpsv (uplo : _byte)
                                   (trans : _byte)
                                   (diag : _byte)
                                   (n : _int)
                                   (AP : (_cpointer 'float))
...
void CUBLASAPI cublasStrmv (char uplo, char trans, char diag, int n, 
                            const float *A, int lda, float *x, int incx);
|#
(define-foreign-cublas cublasStrmv (uplo : _byte)
                                   (trans : _byte)
                                   (diag : _byte)
                                   (n : _int)
                                   (A : (_cpointer 'float))
...
void CUBLASAPI cublasStrsv (char uplo, char trans, char diag, int n, 
                            const float *A, int lda, float *x, int incx);
|#
(define-foreign-cublas cublasStrsv (uplo : _byte)
                                   (trans : _byte)
                                   (diag : _byte)
                                   (n : _int)
                                   (A : (_cpointer 'float))
...
|#
(define-foreign-cublas cublasCgemv (trans : _byte)
                              (m : _int)
                              (n : _int)
                              (alpha : _float2 #|_cuComplex|#)
                              (A : (_cpointer 'cuComplex))
                              (lda : _int)
                              (x : (_cpointer 'cuComplex))
                              (incx : _int)
                              (beta : _float2 #|_cuComplex|#)
                              (y : (_cpointer 'cuComplex))
                              (incy : _int)
                           -> _void
                           -> (values x y))
...
void CUBLASAPI cublasCgbmv (char trans, int m, int n, int kl, int ku,
                            ...
                            cuComplex *y, int incy);
|#
(define-foreign-cublas cublasCgbmv (trans : _byte)
                              (m : _int)
                              (n : _int)
                              (kl : _int)
                              (ku : _int)
...
void CUBLASAPI cublasChemv (char uplo, int n, cuComplex alpha, 
                            ...
                            int incx, cuComplex beta, cuComplex *y, int incy);
|#
(define-foreign-cublas cublasChemv (uplo : _byte)
                              (n : _int)
                              (alpha : _float2 #|_cuComplex|#)
                              (A : (_cpointer 'cuComplex))
                              (lda : _int)
...
void CUBLASAPI cublasChbmv (char uplo, int n, int k, cuComplex alpha,
                            ...
                            int incx, cuComplex beta, cuComplex *y, int incy);
|#
(define-foreign-cublas cublasChbmv (uplo : _byte)
                              (n : _int)
                              (k : _int)
                              (alpha : _float2 #|_cuComplex|#)
                              (A : (_cpointer 'cuComplex))
...
|#
(define-foreign-cublas cublasChpmv  (uplo : _byte)
                              (n : _int)
                              (alpha : _float2 #|_cuComplex|#)
                              (AP : (_cpointer 'cuComplex))
                              (x : (_cpointer 'cuComplex))
                              (incx : _int)
                              (beta : _float2 #|_cuComplex|#)
                              (y : (_cpointer 'cuComplex))
...
void CUBLASAPI  cublasCtrmv (char uplo, char trans, char diag, int n,
                             ...
                             int incx);
|#
(define-foreign-cublas cublasCtrmv (uplo : _byte)
                                   (trans : _byte)
                                   (diag : _byte)
                                   (n : _int)
                                   (A : (_cpointer 'float))
...
void CUBLASAPI cublasCtbmv (char uplo, char trans, char diag, int n, int k, 
                            ...
                            int incx);
|#
(define-foreign-cublas cublasCtbmv (uplo : _byte)
                                   (trans : _byte)
                                   (diag : _byte)
                                   (n : _int)
                                   (A : (_cpointer 'float))
...
|#
(define-foreign-cublas cublasCtpmv (uplo : _byte)
                                   (trans : _byte)
                                   (diag : _byte)
                                   (n : _int)
                                   (AP : (_cpointer 'float))
...
void CUBLASAPI cublasCtrsv (char uplo, char trans, char diag, int n,
                            ...
                            int incx);
|#
(define-foreign-cublas cublasCtrsv (uplo : _byte)
                                   (trans : _byte)
                                   (diag : _byte)
                                   (n : _int)
                                   (A : (_cpointer 'float))
...
void CUBLASAPI cublasCtbsv (char uplo, char trans, char diag, int n, int k, 
                            ...
                            int incx);
|#
(define-foreign-cublas cublasCtbsv (uplo : _byte)
                                   (trans : _byte)
                                   (diag : _byte)
                                   (n : _int)
                                   (k : _int)
...
void CUBLASAPI cublasCtpsv (char uplo, char trans, char diag, int n,
                            const cuComplex *AP, cuComplex *x, int incx);
|#
(define-foreign-cublas cublasCtpsv (uplo : _byte)
                                   (trans : _byte)
                                   (diag : _byte)
                                   (n : _int)
                                   (AP : (_cpointer 'float))
...
void CUBLASAPI cublasCgeru (int m, int n, cuComplex alpha, const cuComplex *x,
                            ...
                            cuComplex *A, int lda);
|#
(define-foreign-cublas cublasCgeru (m : _int)
                                   (n : _int)
                                   (alpha : _float2 #|_cuComplex|#)
                                   (x : (_cpointer 'cuComplex))
                                   (incx : _int)
                                   (y : _float2 #|_cuComplex|#)
                                   (incy : _int)
                                   (A : (_cpointer 'cuComplex))
                                   (lda : _int)
                                -> _void 
...
void CUBLASAPI cublasCgerc (int m, int n, cuComplex alpha, const cuComplex *x,
                            ...
                            cuComplex *A, int lda);
|#
(define-foreign-cublas cublasCgerc (m : _int)
                                   (n : _int)
                                   (alpha : _float2 #|_cuComplex|#)
                                   (x : (_cpointer 'cuComplex))
                                   (incx : _int)
...
void CUBLASAPI cublasCher (char uplo, int n, cuComplex alpha, 
                           ...
                           int lda);
|#
(define-foreign-cublas cublasCher  (uplo : _byte)
                                   (n : _int)
                                   (alpha : _float2 #|_cuComplex|#)
                                   (x : (_cpointer 'cuComplex))
                                   (incx : _int)
...
|#
(define-foreign-cublas cublasChpr (uplo : _byte)
                                  (n : _int)
                                  (alpha : _float2 #|_cuComplex|#)
                                  (x : (_cpointer 'cuComplex))
                                  (incx : _int)
...
|#
(define-foreign-cublas cublasCher2 (uplo : _byte)
                                  (n : _int)
                                  (alpha : _float2 #|_cuComplex|#)
                                  (x : (_cpointer 'cuComplex))
                                  (incx : _int)
...
|#
(define-foreign-cublas cublasChpr2 (uplo : _byte)
                                  (n : _int)
                                  (alpha : _float2 #|_cuComplex|#)
                                  (x : (_cpointer 'cuComplex))
                                  (incx : _int)
...
void CUBLASAPI cublasSgemm (char transa, char transb, int m, int n, int k, 
                            ...
                            int ldc);
|#
(define-foreign-cublas cublasSgemm (transa : _byte)
                                   (transb : _byte)
                                   (m : _int)
                                   (n : _int)
                                   (k : _int)
...
void CUBLASAPI cublasSsymm (char side, char uplo, int m, int n, float alpha, 
                            ...
                            float beta, float *C, int ldc);
|#
(define-foreign-cublas cublasSsymm (side : _byte)
                                   (uplo : _byte)
                                   (m : _int)
                                   (n : _int)
                                   (alpha : _float)
...
void CUBLASAPI cublasSsyrk (char uplo, char trans, int n, int k, float alpha, 
                            ...
                            int ldc);
|#
(define-foreign-cublas cublasSsyrk (uplo : _byte)
                                   (trans : _byte)
                                   (n : _int)
                                   (k : _int)
                                   (alpha : _float)
...
void CUBLASAPI cublasSsyr2k (char uplo, char trans, int n, int k, float alpha, 
                             ...
                             float beta, float *C, int ldc);
|#
(define-foreign-cublas cublasSsyr2k (uplo : _byte)
                                   (trans : _byte)
                                   (n : _int)
                                   (k : _int)
                                   (alpha : _float)
...
void CUBLASAPI cublasStrmm (char side, char uplo, char transa, char diag,
                            ...
                            float *B, int ldb);
|#
(define-foreign-cublas cublasStrmm (side : _byte)
                                   (uplo : _byte)
                                   (transa : _byte)
                                   (diag : _byte)
                                   (m : _int)
...
void CUBLASAPI cublasStrsm (char side, char uplo, char transa, char diag,
                            ...
                            float *B, int ldb);
|#
(define-foreign-cublas cublasStrsm (side : _byte)
                                   (uplo : _byte)
                                   (transa : _byte)
                                   (diag : _byte)
                                   (m : _int)
...
void CUBLASAPI cublasCgemm (char transa, char transb, int m, int n, int k, 
                            ...
                            cuComplex *C, int ldc);
|#
(define-foreign-cublas cublasCgemm (transa : _byte)
                                   (transb : _byte)
                                   (m : _int)
                                   (n : _int)
                                   (k : _int)
...
void CUBLASAPI cublasCsymm (char side, char uplo, int m, int n,
                            ...
                            cuComplex *C, int ldc);
|#
(define-foreign-cublas cublasCsymm (side : _byte)
                                   (uplo : _byte)
                                   (m : _int)
                                   (n : _int)
                                   (alpha : _float)
...
void CUBLASAPI cublasChemm (char side, char uplo, int m, int n,
                            ...
                            cuComplex *C, int ldc);
|#
(define-foreign-cublas cublasChemm (side : _byte)
                                   (uplo : _byte)
                                   (m : _int)
                                   (n : _int)
                                   (alpha : _float)
...
|#
(define-foreign-cublas cublasCsyrk (uplo : _byte)
                                   (trans : _byte)
                                   (n : _int)
                                   (k : _int)
                                   (alpha : _float)
...
void CUBLASAPI cublasCherk (char uplo, char trans, int n, int k,
                            ...
                            cuComplex beta, cuComplex *C, int ldc);
|#
(define-foreign-cublas cublasCherk (uplo : _byte)
                                   (trans : _byte)
                                   (n : _int)
                                   (k : _int)
                                   (alpha : _float)
...
void CUBLASAPI cublasCsyr2k (char uplo, char trans, int n, int k,
                             ...
                             cuComplex *C, int ldc);
|#
(define-foreign-cublas cublasCsyr2k (uplo : _byte)
                                   (trans : _byte)
                                   (n : _int)
                                   (k : _int)
                                   (alpha : _float)
...
void CUBLASAPI cublasCher2k (char uplo, char trans, int n, int k,
                             ...
                             cuComplex *C, int ldc);
|#
(define-foreign-cublas cublasCher2k (uplo : _byte)
                                   (trans : _byte)
                                   (n : _int)
                                   (k : _int)
                                   (alpha : _float)
...
|#
(define-foreign-cublas cublasCtrmm (side : _byte)
                                   (uplo : _byte)
                                   (trans : _byte)
                                   (diag : _byte)
                                   (m : _int)
...
void CUBLASAPI cublasCtrsm (char side, char uplo, char transa, char diag,
                            ...
                            int lda, cuComplex *B, int ldb);
|#
(define-foreign-cublas cublasCtrsm (side : _byte)
                                   (uplo : _byte)
                                   (trans : _byte)
                                   (diag : _byte)
                                   (m : _int)
...
|#
(define-foreign-cublas cublasDasum (n : _int)
                                   (x : (_cpointer 'double))
                                   (incx : _int)
                                -> (_cpointer 'double))
...
void CUBLASAPI cublasDaxpy (int n, double alpha, const double *x, int incx, 
                            double *y, int incy);
|#
(define-foreign-cublas cublasDaxpy (n : _int)
                                   (alpha : _double)
                                   (x : (_cpointer 'double))
                                   (incx : _int)
                                   (y : (_cpointer 'double))
...
void CUBLASAPI cublasDcopy (int n, const double *x, int incx, double *y, 
                            int incy);
|#
(define-foreign-cublas cublasDcopy (n : _int)
                                   (x : (_cpointer 'double))
                                   (incx : _int)
                                   (y : (_cpointer 'double))
                                   (incy : _int)
...
double CUBLASAPI cublasDdot (int n, const double *x, int incx, const double *y,
                             int incy);
|#
(define-foreign-cublas cublasDdot  (n : _int)
                                   (x : (_cpointer 'double))
                                   (incx : _int)
                                   (y : (_cpointer 'double))
                                   (incy : _int)
...
|#
(define-foreign-cublas cublasDnrm2 (n : _int)
                                   (x : (_cpointer 'double))
                                   (incx : _int)
                                -> (result : _double))
...
void CUBLASAPI cublasDrot (int n, double *x, int incx, double *y, int incy, 
                           double sc, double ss);
|#
(define-foreign-cublas cublasDrot  (n : _int)
                                   (x : (_cpointer 'double))
                                   (incx : _int)
                                   (y : (_cpointer 'double))
                                   (sc : _double)
...
|#
(define-foreign-cublas cublasDrotg (sa : (_ptr io _double))
                                   (sb : (_ptr io _double))
                                   (sc : (_ptr o _double))
                                   (ss : (_ptr o _double))
                                -> _void
...
void CUBLASAPI cublasDrotm(int n, double *x, int incx, double *y, int incy, 
                           const double* sparam);
|#
(define-foreign-cublas cublasDrotm (n : _int)
                                   (x : (_cpointer 'double))
                                   (incx : _int)
                                   (y : (_cpointer 'double))
                                   (sparam : (_ptr o (_cpointer 'double)))
                                -> _void
                                -> (values x y sparam))
...
|#
(define-foreign-cublas cublasDrotmg (sd1 : (_ptr io _double))
                                    (sd2 : (_ptr io _double))
                                    (sx1 : (_ptr io _double))
                                    (sy1 : _double)
                                    (sparam : (_ptr o (_cpointer 'double)))
...
|#
(define-foreign-cublas cublasDscal (n : _int)
                                   (alpha : _double)
                                   (x : (_cpointer 'double))
                                   (incx : _int)
                                -> _void
...
|#
(define-foreign-cublas cublasDswap (n : _int)
                                   (x : (_cpointer 'double))
                                   (incx : _int)
                                   (y : (_cpointer 'double))
                                   (incy : _int)
...
|#
(define-foreign-cublas cublasIdamax (n : _int)
                                    (x : (_cpointer 'double))
                                    (incx : _int)
                                 -> _int)
...
|#
(define-foreign-cublas cublasIdamin (n : _int)
                                    (x : (_cpointer 'double))
                                    (incx : _int)
                                 -> _int)
...
|#
(define-foreign-cublas cublasDgemv (trans : _byte)
                                   (m : _int)
                                   (n : _int)
                                   (alpha : _double)
                                   (A : (_cpointer 'double))
...
void CUBLASAPI cublasDger (int m, int n, double alpha, const double *x,
                           ...
                           double *A, int lda);
|#
(define-foreign-cublas cublasDger  (m : _int)
                                   (n : _int)
                                   (alpha : _double)
                                   (x : (_cpointer 'double))
                                   (incx : _int)
...
void CUBLASAPI cublasDsyr (char uplo, int n, double alpha,
                           ...
                           int lda);
|#
(define-foreign-cublas cublasDsyr  (uplo : _byte)
                                   (n : _int)
                                   (alpha : _double)
                                   (x : (_cpointer 'double))
                                   (incx : _int)
...
void CUBLASAPI cublasDtrsv (char uplo, char trans, char diag, int n, 
                            ...
                            int incx);
|#
(define-foreign-cublas cublasDtrsv (uplo : _byte)
                                   (trans : _byte)
                                   (diag : _byte)
                                   (n : _int)
                                   (A : (_cpointer 'double))
...
void CUBLASAPI cublasDgemm (char transa, char transb, int m, int n, int k,
                            ...
                            int ldc);
|#
(define-foreign-cublas cublasDgemm (transa : _byte)
                                   (transb : _byte)
                                   (m : _int)
                                   (n : _int)
                                   (k : _int)
...
void CUBLASAPI cublasDtrsm (char side, char uplo, char transa,
                            ...
                            int ldb);
|#
(define-foreign-cublas cublasDtrsm (side : _byte)
                                   (uplo : _byte)
                                   (transa : _byte)
                                   (diag : _byte)
                                   (m : _int)
...
void CUBLASAPI cublasDtrmm (char side, char uplo, char transa,
                            ...
                            int ldb);
|#
(define-foreign-cublas cublasDtrmm (side : _byte)
                                   (uplo : _byte)
                                   (transa : _byte)
                                   (diag : _byte)
                                   (m : _int)
...
void CUBLASAPI cublasDsymm (char side, char uplo, int m, int n,
                            ...
                            double *C, int ldc);
|#
(define-foreign-cublas cublasDsymm (side : _byte)
                                   (uplo : _byte)
                                   (m : _int)
                                   (n : _int)
                                   (alpha : _double)
...
void CUBLASAPI cublasDsyrk (char uplo, char trans, int n, int k,
                            ...
                            double beta, double *C, int ldc);
|#
(define-foreign-cublas cublasDsyrk (uplo : _byte)
                                   (trans : _byte)
                                   (n : _int)
                                   (k : _int)
                                   (alpha : _double)
...
void CUBLASAPI cublasDsyr2k (char uplo, char trans, int n, int k,
                             ...
                             double *C, int ldc);
|#
(define-foreign-cublas cublasDsyr2k (uplo : _byte)
                                   (trans : _byte)
                                   (n : _int)
                                   (k : _int)
                                   (alpha : _double)
...
void CUBLASAPI cublasZgemm (char transa, char transb, int m, int n,
                            ...
                            int ldc);
|#
(define-foreign-cublas cublasZgemm (transa : _byte)
                                   (transb : _byte)
                                   (m : _int)
                                   (n : _int)
                                   (k : _int)
                                   (alpha : _double2 #|_cuDoubleComplex|#)
                                   (A : (_cpointer 'doubleComplex))
                                   (lda : _int)
                                   (B : (_cpointer 'doubleComplex))
                                   (ldb : _int)
                                   (beta : _double2 #|_cuDoubleComplex|#)
                                   (C : (_cpointer 'doubleComplex))
                                   (ldc : _int)
                                -> _void
                                -> C)
