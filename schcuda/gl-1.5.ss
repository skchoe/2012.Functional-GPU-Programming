(module gl-1.5 scheme
  ...
  (define glew-lib (case (system-type)                                          
                   [(windows) (ffi-lib "opengl32")]                             
                   [(macosx) (ffi-lib "/System/Library/Frameworks/OpenGL.framewo
rk/Versions/A/Libraries/libGL")]                                                
                   [else (ffi-lib (string-append (path->string (find-system-path 'home-dir))"/local/glew/lib/libGLEW"))]))     
