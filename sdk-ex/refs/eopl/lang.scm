(module lang mzscheme
  ...
  #|
  top-level  = program (expression)           - a program
  expression = (number)                       - const-exp
             ...
             | proc ( identifier : optional-type ) expression  - proc-exp
  ...
  type = int                                  - int-type
       | bool                                 - bool-type
       | (type -> type)                       - proc-type
       | %tvar-type number                    - tvar-type

  |#
  (define the-grammar
    '((program (expression) a-program)

      ; currently used by expression below
      (expression (number) const-exp)
      ...
      ; define
      (expression
        ("(define" identifier optional-type ")" expression ")")
        proc-exp)
