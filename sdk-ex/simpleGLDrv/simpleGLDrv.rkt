...
(printf "4")
	...
	(cuCtxSynchronize)
        (if (not (equal? resulti 'CUDA_SUCCESS))
            ...
            (begin (printf "cudaGLInit successful: vbo ~s\n" vb)
        ...
        (with-gl-context
         (lambda ()
           ...
           (unless vbo-init
             ...
             (let* ([cubin-name (generate-cubin "data/simpleGLDrv_kernel.cubin")]
...
(printf "0")
               ...
               ;;first run of run-cuda map the computed data to buffer object
