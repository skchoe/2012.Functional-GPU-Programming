...
(module array racket
  ...
  ; to help wrapper functions
  (require "utils.ss")
  
  (provide array? make-array shape array array-rank
	   array-start array-end array-ref array-set! share-array share-array*
	   ...
	   shape-for-each shape-for-each*
           array-for-each-index array-for-each-index*
	   tabulate-array tabulate-array! tabulate-array* tabulate-array!-v tabulate-array!-a
           array-retabulate! array-map array-map!
	   array->vector share-array/prefix share-array/origin
	   array-append transpose share-nths
           
           ;; Newly added for export from arlib.ss
           array->list share-array/index!
           
           ;; Newly added for printing array element from "example/play.scm"
           play
           )
...
;;; (share-array* array shape proc)
;;; The arguments to `proc' are list of indices of result.  The values of
;;; `proc' are list of indices of `array'.
;;   f : (Listof Number) -> (Listof Number)
  (define (share-array* array subshape f)
    (let* ([g (lst2lst->vals2vals f)]) ; g values -> values 
      (share-array  array subshape g)))
